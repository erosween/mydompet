...
const REGISTRY_FILE = new URL("../app/license-registry.json", import.meta.url);
...
if (options.api) console.log("Registry: app/license-registry.json updated");
if (options.api) console.log('Next: git add app/license-registry.json && git commit -m "Add license token" && git push origin main');
